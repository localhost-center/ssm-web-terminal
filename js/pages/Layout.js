...
gotourl() {
  window.open('https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-access.html');
}
      ...
      <Container fluid>
       ...
       <Grid >    
        ...
        <Grid.Column width={4} style={{'height':'100vh', 'overflowY':'auto'}}>
          ...
          <Grid.Column width={2}>
          <Button primary style={{'width':'100%'}} onClick={this.showAuthModal}>인증</Button>
          </Grid.Column>
          <br></br>
          <Grid.Column width={2}>
          <Button secondary style={{'width':'100%'}} onClick={this.showSettingsModal}>설정</Button>
          </Grid.Column>
          <br></br>
          <Grid.Column width={2}>
          <Button info style={{'width':'100%'}} onClick={this.gotourl}>SSM 설정방법</Button>
          </Grid.Column>
          {/* <br></br>
          <Grid.Column width={2}>
